...
var car = new Car(3000, 'Toyota', 'RAV 4', 2018);
var car2 = new Car(3500, 'BMW', 'X6', 2019);
console.log(car.info());
car.used = 'new';
console.log(car.info()); //-- год изменен
car.used = 'used';
console.log(car.info()); //-- изменения не выполняются
console.log(car2.info());
car.used = 'used';
console.log(car2.info()); //-- изменения не выполняются
